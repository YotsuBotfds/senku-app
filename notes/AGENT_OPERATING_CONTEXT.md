...
```powershell
& .\.venvs\senku-validate\Scripts\python.exe -B -m py_compile query.py bench.py query_abstain_policy.py query_answer_card_runtime.py query_citation_policy.py query_completion_hardening.py query_response_normalization.py query_prompt_runtime.py query_scenario_frame.py rag_bench_answer_diagnostics.py query_routing_predicates.py deterministic_special_case_registry.py special_case_builders.py scripts\analyze_rag_bench_failures.py tests\test_special_cases.py tests\test_query_routing.py tests\test_query_abstain_policy.py tests\test_query_answer_card_runtime.py tests\test_query_citation_policy.py tests\test_query_completion_hardening.py tests\test_query_response_normalization.py tests\test_query_prompt_runtime.py tests\test_query_scenario_frame.py tests\test_rag_bench_answer_diagnostics.py
