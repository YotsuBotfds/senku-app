...
- `notes/ANDROID_VISUAL_QA_20260428_0250.md`: post-wave14 analysis-only punch
  list against `artifacts/ui_state_pack/20260428_024021` and `artifacts/mocks`.
  It ranks remaining blockers as Answer, Thread, Emergency, Guide, Search, then
...
- Current anchor and proof reconciled to `fbf69e0` and
...
- Compare `guideDetailShowsRelatedGuideNavigation` and off-rail cross-reference
  screenshots/dumps from `20260428_035816`.
