...
def _build_heat_illness_emergency_response():
    ...
    return (
        ...
        "3. Check airway, breathing, and responsiveness. Give small sips of known-safe water or oral rehydration only if fully awake and "
        "able to swallow; do not make questionable drinking water the main fix, and do not force fluids into someone confused, collapsed, vomiting, or hard to wake. [GD-232, GD-377]\n"
        "4. If this followed pesticide or chemical spraying, separate that lane without delaying cooling: move upwind and away "
        "from the source, remove contaminated clothing if safe, rinse exposed skin/eyes with clean water when available, and "
        "save the product label or name for poison-control or emergency responders. [GD-054, GD-602]\n"
        "5. If symptoms are only dizziness and nausea after heat work and they improve quickly with cooling and fluids, keep "
