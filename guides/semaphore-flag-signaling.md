---
id: GD-889
slug: semaphore-flag-signaling
title: Semaphore & Flag Signaling
...
In scenarios where radio is unavailable, jammed, or too risky to use (stealth/security), flag signals offer:
- No electronic signature to detect
- Line-of-sight only (receiver must be visible)
- Directional (harder to intercept from the side)
...
| Letter | Left Arm Position | Right Arm Position |
|--------|-------------------|-------------------|
| A | 6 o'clock (down) | 7 o'clock (lower-left diagonal) |
| B | 5 o'clock (lower-right diagonal) | 8 o'clock (lower-left diagonal) |
| C | 3 o'clock (horizontal right) | 6 o'clock (down) |
| D | 12 o'clock (up) | 8 o'clock (lower-left diagonal) |
| E | 12 o'clock (up) | 6 o'clock (down) |
| F | 12 o'clock (up) | 7 o'clock (lower-left diagonal) |
| G | 12 o'clock (up) | 5 o'clock (lower-right diagonal) |
| H | 7 o'clock (lower-left diagonal) | 5 o'clock (lower-right diagonal) |
| I | 6 o'clock (down) | 12 o'clock (up) |
| J | 6 o'clock (down) | 1 o'clock (upper-right diagonal) |
| K | 7 o'clock (lower-left diagonal) | 6 o'clock (down) |
| L | 9 o'clock (horizontal left) | 6 o'clock (down) |
| M | 9 o'clock (horizontal left) | 12 o'clock (up) |
| N | 5 o'clock (lower-right diagonal) | 6 o'clock (down) |
| O | 9 o'clock (horizontal left) | 3 o'clock (horizontal right) |
| P | 6 o'clock (down) | 5 o'clock (lower-right diagonal) |
| Q | 6 o'clock (down) | 8 o'clock (lower-left diagonal) |
| R | 6 o'clock (down) | 9 o'clock (horizontal left) |
| S | 6 o'clock (down) | 3 o'clock (horizontal right) |
| T | 6 o'clock (down) | 2 o'clock (upper-right diagonal) |
| U | 7 o'clock (lower-left diagonal) | 5 o'clock (lower-right diagonal) |
| V | 6 o'clock (down) | 4 o'clock (lower-right diagonal) |
| W | 6 o'clock (down) | 11 o'clock (upper-left diagonal) |
| X | 8 o'clock (lower-left diagonal) | 4 o'clock (lower-right diagonal) |
| Y | 6 o'clock (down) | 10 o'clock (upper-left diagonal) |
| Z | 5 o'clock (lower-right diagonal) | 12 o'clock (up) |

### Special Signals

| Signal | Position | Meaning |
|--------|----------|---------|
| Attention | Both arms 11-12-1 o'clock (overhead) waving vertically | Start, get ready to receive |
| Numerals | Both arms at 6 o'clock (down) then crossed X | Switch to number mode |
| J (Letter J) | 6 o'clock down, 1 o'clock diagonal right | Return to letter mode after numerals |
| Error | Both arms at 6 o'clock (down), held still | Cancel last word, start over |
| End of Word | Arms crossed overhead in X, then dropped | Space between words (brief pause) |
| End of Message | Both arms 12 o'clock (up), cross overhead slowly | Transmission complete |

### Numerals Mode

Once you transmit the **Numerals** signal (arms crossed), the next signals represent numbers:

| Number | Left Arm | Right Arm | Equivalent Letter |
|--------|----------|-----------|-------------------|
| 0 | 5 o'clock | 12 o'clock | Z |
| 1 | 6 o'clock | 12 o'clock | I |
| 2 | 7 o'clock | 5 o'clock | U |
| 3 | 3 o'clock | 6 o'clock | C |
| 4 | 6 o'clock | 4 o'clock | V |
| 5 | 7 o'clock | 5 o'clock | H |
| 6 | 9 o'clock | 12 o'clock | M |
| 7 | 9 o'clock | 3 o'clock | O |
| 8 | 5 o'clock | 8 o'clock | B |
| 9 | 6 o'clock | 9 o'clock | R |

After spelling a number, send the **J** signal to return to letter mode. Example: to send "123" you would send Numerals, then I, then U, then C, then J to resume letters.

:::tip
**Clock Notation Shortcut:** Always hold your arms perpendicular to the ground. Imagine a clock face on your body: 12 is straight up, 3 is straight out to your right, 6 is straight down, 9 is straight out to your left. Diagonals split the difference. With practice, positions become automatic and require no mental translation.
:::

</section>

<section id="flag-construction">

## Flag Construction

Effective semaphore signaling requires flags large and visible enough to be seen at distance. Improvised flags can be made from common materials found in most survival or home contexts.
...
3. Fold one edge of the fabric over the handle and secure with:
   ...
   - Cable ties or twine wrapped tightly around the fabric and handle together
4. Trim excess fabric if needed; the flag should hang freely and move independently

### Color Guidelines

| Color Pair | Visibility | Notes |
|------------|-----------|-------|
| Red + Yellow | Excellent (traditional) | High visibility in daylight, works in haze |
| White + Black | Very Good | Maximum contrast, readable even in low light |
| White + Orange | Very Good | Orange visible at range, less affected by sky color |
| White + Blue | Good | Depends on sky color; avoid when sky is blue |
| Red + White | Good | Adequate contrast; traditional naval variant |

**Monochrome alternative:** If only one color is available, sew or glue strips of contrasting material (tape, cloth) to increase visibility. White tape strips on a dark background, or dark strips on white, both work.

### Night Adaptation

For nighttime signaling (see Night Signaling section), attach reflective material or paint:
- Apply 3M reflective tape (white or silver) to flag edges or one side
- Paint flags with reflective paint (available from safety suppliers)
- Attach lanterns or torches to handles using loops or clips (see Night Signaling for safety)

### Care and Maintenance

- Rinse flags in fresh water regularly to prevent salt/dirt buildup (especially important if stored outdoors)
- Inspect handles for splinters and sand/seal rough wood with oil to prevent hand injury
- Store flags in a dry place when not in use; damp flags are harder to wave and take longer to respond to movements
- Replace flags if seams tear or significant fabric loss occurs

:::warning
**Torn flags are dangerous:** Bits of tearing fabric catch wind unpredictably, causing the signal to blur. Always maintain flags in good condition, especially for long-distance signaling where precision is critical.
:::

</section>

<section id="sending-procedures">

## Sending Procedures

Effective flag signaling follows a strict protocol to ensure the receiver understands the message and can acknowledge receipt. Deviations cause confusion and errors.

### Getting Attention

Before sending any message, the receiver must be alert and focused on you:

1. Hold both flags overhead (11 o'clock to 1 o'clock position) and wave them in a vertical arc (up and down) slowly and deliberately
2. Continue until the receiver acknowledges with both arms raised straight up briefly
...
**Timing is critical:** Too-fast transmission blurs letters together. Too-slow transmission is tedious. Aim for roughly one letter per second (including the pause between positions). Beginners should aim for 2 WPM (roughly 10 seconds per 5-letter word).
...
If the receiver does not understand a letter or word, or if the sender recognizes an error:

1. **Error signal:** Lower both arms to 6 o'clock (straight down) and hold for 2 seconds
2. **Meaning:** "Cancel the last word I sent; ignore it."
3. **Recovery:** Return attention signal, then re-send the word or phrase

Alternative: Continue sending, then spell **WORD ERROR** at the end to flag a specific problem for the receiver to address. Use **LETTER ERROR** to flag a single misread letter.

### Abbreviations and Common Phrases

For speed, operators often pre-establish abbreviations:

- **MSG = MESSAGE:** "Do you copy?"
- **OK = Acknowledged:** "Message received and understood"
- **REPEAT = Please repeat last word**
- **OUT = End of transmission** (final message ender)
- **WAIT = Standby, hold position**
- **URGENT = Priority message, send immediately**
- **STAND BY = Will transmit shortly**
...
<section id="receiving-decoding">

## Receiving & Decoding

Receiving flag signals is harder than sending them because the receiver must mentally reverse left and right (mirror image problem). Receivers should train from a receiver's perspective, not just by watching a sender.

### Positioning for Optimal Reception

- **Face the sender directly:** Stand perpendicular to the sun (so light does not obscure the sender's position) and position yourself so the sender is clearly silhouetted or well-lit
- **Establish visual angle:** Ensure the sender's full body (from feet to raised arms) is visible; do not stand so close that you lose the arm positions
- **Use binoculars for distance:** For ranges >1 km, binoculars are essential; stabilize them with a monopod or rest them on a shoulder/wall to reduce arm fatigue
- **Place a spotter behind you:** For critical messages, assign one person to receive and another to stand beside them with a notebook, calling out the received letters to ensure accuracy

### The Mirror-Image Problem

This is the key challenge for receivers. When the sender raises their left arm to 12 o'clock and right arm to 3 o'clock, the receiver sees the sender's left arm as appearing on the right side of the receiver's visual field (because the receiver faces the sender). This mirror reversal must become automatic:

**Mental reversal technique:**
- Imagine you are standing inside the sender's body, looking outward
- The sender's left arm is on your right
...
Use a notebook with prepared columns:

| Letter | Time | Confidence | Notes |
|--------|------|------------|-------|
| A | 00:05 | High | Clear position |
| B | 00:06 | Medium | Brief; confirm? |
| C | 00:07 | High | Distinct |

When in doubt about a letter, jot a **?** and ask for repetition later. Do not interrupt the sender mid-transmission unless they initiate an error signal.

### Acknowledgment Protocol

- **After each word:** Raise both arms straight up (vertical position, palms facing sender) briefly (1 second)
- **Meaning:** "I received that word; continue."
- **If you missed a word:** Do not raise arms; sender will notice no acknowledgment and initiate error correction
...
<section id="tower-to-tower-relay">
...
Stations must be positioned for line-of-sight continuity:

- **Hilltops and ridgelines:** Natural relay points; position flagpoles or tall structures to maximize visibility
- **Rooftops:** Urban or village relay; ensure strong attachment to prevent wind damage
- **Tall trees:** Temporary relay (tree-climbing protocols required; secure operators with safety lines)
- **Towers (masts):** Permanent or semi-permanent relay infrastructure; must be engineered for wind loads

**Visibility testing:** Before establishing a relay, test sightlines with mirrors or bright clothing during daylight. If line-of-sight is blocked, the relay cannot function.
...
Relay messages must include explicit addressing to ensure the correct station acts on the message:

**Format:** `TO: [DESTINATION] / FROM: [ORIGIN] / MESSAGE: [content] / END`

Example:
```
TO: STATION CHARLIE
FROM: STATION ALPHA
MESSAGE: FOOD SUPPLY CONVOY ARRIVES 1400 HOURS MONDAY STOP PREPARE STORAGE AREA STOP
END
```

Each station in the relay chain:
1. Receives the complete message (including addressing)
2. Records it verbatim
3. Checks the "TO:" field to see if they are the final destination
4. If not the destination, re-transmits the entire message to the next station in the chain
5. If destination is reached, processes the message and sends an acknowledgment back through the relay chain

### Acknowledgment Protocol for Relays

Each relay station must acknowledge receipt **before** re-transmitting:

1. **Receiver acknowledgment:** Both arms up briefly after final word of message
2. **Sender acknowledgment:** Both arms up briefly to confirm receiver has acknowledged
3. **Re-transmission begins:** Sender now becomes receiver; the next relay station begins transmission from the current station

### Relay Speed and Error Accumulation
...
**Error accumulation risk:** If a letter is misread at the first relay, it propagates downstream to all subsequent stations. Minimize this by:
- Using expansive signals (deliberate, slow positions)
- Having both sender and receiver confirm every word (send REPEAT after completion if any doubt)
- Spelling difficult words by single letters rather than assuming a known acronym will be understood

:::warning
**Relay chain breaking:** If any station in the relay cannot see the next station (e.g., fog rolls in, trees block line-of-sight), the entire chain breaks. Maintain spare relay routes or pre-position multiple relays along alternate paths. A broken relay can cascade to system-wide communication failure.
:::

</section>

<section id="night-signaling">
...
### Basic Morse Alphabet (Simplified Reference)
...
Learning Morse for backup signaling is a one-week project for beginners. See <a href="../morse-code-fundamentals.html">morse-code-fundamentals</a> for a complete guide.

### Lantern Shutter System

For directional signaling (to avoid broadcasting to adversaries), build a simple shutter:

1. Take a metal tube (or cardboard tube wrapped in foil) slightly larger than the lantern diameter
2. Attach a sliding plate or hinged flap inside the tube that opens and closes to create flashes
3. Mount the lantern at the rear; the shutter faces outward
4. Sliding the plate creates clean start/stop of light, reducing scattered light

This concentrates the signal beam in one direction, making it invisible from the sides.

### Fire Discipline and Safety

:::warning
**Fire risk:** Torches and lanterns are open flames. Never signal with them in dry brush or forested areas prone to fire. Use only in cleared areas or with water and fire extinguisher nearby.

**Detection risk:** Night lantern signaling is visible for many kilometers. If you are trying to avoid being located, do not signal at night. Use Morse only with trusted, pre-positioned receiver stations.

**Operator safety:** Lantern signals cause fatigue and can result in burns if the operator loses focus. Rotate operators every 15 minutes or use two-person teams (one holds lantern, one controls shutter).
:::

### Comparison: Semaphore vs. Morse for Night Operations
...
**Hybrid approach:** Use Morse via lantern for night, semaphore via flags during day. Operators trained in both systems can switch seamlessly.
...
Becoming proficient at flag signaling requires structured, progressive practice. This 3-week program takes a beginner from alphabet memorization to operational readiness.

### Week 1: Alphabet and Reference Mastery
...
### Week 3: Pair Practice and Reception
...
|---------|--------------|----------|
| Receiver cannot see letters clearly | Distance too far, insufficient contrast, or poor flag visibility | Move closer, use binoculars, switch to higher-contrast flags (white and black), check flag fabric for tears or fading |
| Sender's positions are jerky or unclear | Arm transitions too fast or inconsistent pausing | Slow down to 0.5 letter/second; use a metronome; practice holding each position for exactly 1 second |
| Receiver misreads letters consistently (especially mirror-image pairs) | Receiver not trained from receiver's perspective | Drill mirror-reversal technique; practice receiving 20+ messages; swap roles with training partner frequently |
...
<section id="affiliate-and-resources">
